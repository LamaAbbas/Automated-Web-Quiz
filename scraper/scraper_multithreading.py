    ...
    for i in range(0, 13):
        ...
        if "How" in question_list:
            ...
            if "outside" in question_list:
                ...
                current_answer = 'Ebon Stymphalian' # one problem
    ...
    for i in range(0, 13):
        ...
        if "Who" in question_list:
            if "Scurvy" in question_list:
                current_answer = 'Captain Dan' # one problem
            ...
            if "Windstone" in question_list:
                current_answer = 'Violet' # one problem
    ...
    for i in range(0, 13):
        ...
        if "Who" in question_list:
            ...
            if "Flameright" in question_list:
                ...
                current_answer = 'Thulinn' # had one problem
    ...
    for i in range(0, 13):
        ...
        if "Who" in question_list:
            if "prophesizes" in question_list:
                ...
                current_answer = 'Mrs. Dowager' # had one problem
